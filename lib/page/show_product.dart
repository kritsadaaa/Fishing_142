...
import 'package:crud_142/page/add_product.dart';
import 'package:crud_142/page/edit_product.dart';
...
class _ShowProductState extends State<ShowProduct> {
  ...
  Future<void> getList() async {
    products = [];
    var url = Uri.parse('https://64202142.pungpingcoding.online/api/product');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Kritsada Fishing'),
        backgroundColor: Color.fromARGB(255, 110, 209, 255),
        actions: [
          Row(
            children: [
              ...
              Text('$username',
                  style:
                      const TextStyle(color: Color.fromARGB(255, 6, 43, 252))),
            ],
          ),
          IconButton(
            onPressed: () async {
  ...
  Future<void> deleteProduct(int id) async {
    var url =
        Uri.parse('https://64202142.pungpingcoding.online/api/product/$id');
  ...
  Future<void> logout(BuildContext context) async {
    ...
    var url = Uri.parse('https://64202142.pungpingcoding.online/api/logout');
