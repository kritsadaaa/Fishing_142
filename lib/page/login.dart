...
import 'package:crud_142/page/show_product.dart';
...
class LoginScreen extends StatelessWidget {
  ...
  Future<String?> _authUser(LoginData data) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://64202142.pungpingcoding.online/api/login'),
        body: {
          'email': data.name,
  ...
  Future<String?> _signupUser(SignupData data) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://64202142.pungpingcoding.online/api/register'),
  ...
  Widget build(BuildContext context) {
    return FlutterLogin(
      // title: 'PK SHOP',
      theme: LoginTheme(
        primaryColor: Color.fromARGB(255, 57, 82, 243),
        pageColorLight: Color.fromARGB(255, 57, 82, 243),
        accentColor: Color.fromARGB(255, 57, 82, 243),
        switchAuthTextColor: const Color.fromARGB(255, 57, 82, 243),
        authButtonPadding: EdgeInsets.only(top: 30, bottom: 30),
        cardTheme: CardTheme(
          elevation: 2,
      ...
      logo: const AssetImage('assets/images/logo-nobg.png'),
      onLogin: _authUser,
